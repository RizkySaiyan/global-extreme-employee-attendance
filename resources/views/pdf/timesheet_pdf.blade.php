    ...
    <div class="wrapping-1">
        <div class="wrapping-body">
            <div class="header m-b-40">
                <div class="logo pull-left w-30">
                    <img src="https://storage.globalxtreme-gateway.net/link/share/images/logo/globalxtreme/gx_new_logo.png"
                        alt="" height="auto" width="200px">
                </div>
                <div class="pull-right w-40" style="width: 350px">
                    <h2 class="no-margin">{{ $title }}</h2>
                    <h3 class="no-margin"> Date : {{ $date }}</h3>
                </div>
            </div>
            <table border="1" style="margin-top:50px;">
                ...
                @foreach($timesheets as $timesheet)
                    <tr>
                        ...
                        <td>{{ $timesheet['shift']['name'] }}</td>
                        <td>{{ $timesheet['clockIn']['time'] }}</td>
                        <td>{{ $timesheet['clockOut']['time'] }}</td>
                ...
                <div class="row w-100">
                    ...
                    <div class="w-50">
                        <div class="pull-right w-40">
                            ...
                            <p class="tx-right">GlobalXtreme</p>
                        </div>
                    </div>
                </div>
            </div>
